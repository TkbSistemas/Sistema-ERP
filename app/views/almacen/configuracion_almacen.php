...
Session::requireLogin(['Almacen', 'Administrador']);
...
$seccion_activa = 'configuracion_almacen';
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Configuración de Almacén | TAKAB</title>
    ...
    <div class="content-area">
        ...
        <main class="dashboard-main employee-settings-main">
            <div class="dashboard-header-row">
                <div>
                    <h1 class="page-title-icon"><i class="fa-solid fa-user-gear" aria-hidden="true"></i> CONFIGURACIÓN DE ALMACÉN</h1>
                    <span class="dashboard-desc">Administra la Seguridad de tu Cuenta de Almacén.</span>
                </div>
            </div>
            ...
            <section class="password-settings-card">
                ...
                <form method="post" action="<?= htmlspecialchars(Session::url('configuracion_almacen'), ENT_QUOTES, 'UTF-8') ?>" class="password-settings-form" autocomplete="off">
